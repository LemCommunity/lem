...
LOCAL_APPS = ["backend.apps.users", "backend.apps.forum", "backend.apps.books"]
...
JWT_AUTH_COOKIE = "lem-auth-cookie"
JWT_AUTH_REFRESH_COOKIE = "lem-auth-token"
...
SPECTACULAR_SETTINGS = {
    "TITLE": "LEM API",
    "DESCRIPTION": "Documentation of API endpoints of LEM",
    "VERSION": "1.0.0",
